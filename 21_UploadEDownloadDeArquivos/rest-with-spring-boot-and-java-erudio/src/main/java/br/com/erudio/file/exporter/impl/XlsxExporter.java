...
public class XlsxExporter implements FileExporter {
    ...
    public Resource exportFile(List<PersonDTO> people) throws Exception {
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            Sheet sheet = workbook.createSheet("People"); // criando um aba na planilha chamada "People", Sheet -> Aba da planilha

            Row headerRow = sheet.createRow(0); // criando um header na primeira linha
